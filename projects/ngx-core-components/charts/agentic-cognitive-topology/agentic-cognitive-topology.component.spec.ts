...
import { AgenticCognitiveTopologyComponent } from './agentic-cognitive-topology.component';
import { ChartExportService } from '../shared/chart-export.service';

describe('AgenticCognitiveTopologyComponent', () => {
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [AgenticCognitiveTopologyComponent],
      providers: [
        {
  ...
  it('should create and render with mock data', () => {
    const fixture = TestBed.createComponent(AgenticCognitiveTopologyComponent);
    const component = fixture.componentInstance;
    try { fixture.componentRef.setInput('nodes', [{ id: "1", label: "A", value: 10, group: "G1", x: 5, y: 10, text: "A", weight: 5, source: "A", target: "B" }]); } catch(e) {}
    try { fixture.componentRef.setInput('links', [{ id: "1", label: "A", value: 10, group: "G1", x: 5, y: 10, text: "A", weight: 5, source: "A", target: "B" }]); } catch(e) {}
