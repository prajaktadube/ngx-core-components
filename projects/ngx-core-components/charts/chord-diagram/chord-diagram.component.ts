...
export class ChordDiagramComponent {
  ...
  exportToCsv(): void {
    ...
    link.setAttribute('download', 'chord-diagram-data.csv');
  ...
  exportToJson(): void {
    ...
    const link = document.createElement('a');
    link.href = URL.createObjectURL(blob);
    link.setAttribute('download', 'chord-diagram-data.json');
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
  }
  ...
  exportToSvg(): void {
    ...
    const link = document.createElement('a');
    link.href = URL.createObjectURL(blob);
    link.setAttribute('download', 'chord-diagram.svg');
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
  }
  ...
  exportToPdf(): void {
    ...
    const printTemplate = `
      ...
      <body>
        <div class="header">
          <div class="title">Chord Diagram Analytics</div>
