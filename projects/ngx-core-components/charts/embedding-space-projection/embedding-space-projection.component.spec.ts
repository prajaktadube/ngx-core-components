...
import { EmbeddingSpaceProjectionComponent } from './embedding-space-projection.component';

describe('EmbeddingSpaceProjectionComponent', () => {
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [EmbeddingSpaceProjectionComponent],

    }).compileComponents();
  });

  it('should create and render with mock data', () => {
    const fixture = TestBed.createComponent(EmbeddingSpaceProjectionComponent);
    const component = fixture.componentInstance;
    try { fixture.componentRef.setInput('data', [{ id: "1", label: "A", value: 10, group: "G1", x: 5, y: 10, text: "A", weight: 5, source: "A", target: "B" }]); } catch(e) {}
