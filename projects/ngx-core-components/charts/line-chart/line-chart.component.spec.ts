...
describe('LineChartComponent', () => {
  ...
  it('should execute interaction handlers and export functions', () => {
    ...
    try { (component as any).onPointClick(0, 0, new MouseEvent('mousemove'), {} as any); } catch(e) {}
    try { (component as any).onPointClick(0, new MouseEvent('click'), {} as any); } catch(e) {}
    try { (component as any).onPointClick(new MouseEvent('mousemove')); } catch(e) {}
    try { (component as any).onPointClick(); } catch(e) {}
