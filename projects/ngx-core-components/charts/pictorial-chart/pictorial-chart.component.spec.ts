...
describe('PictorialChartComponent', () => {
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [PictorialChartComponent],
      providers: [
        {
  ...
  it('should create and render with mock data', () => {
    const fixture = TestBed.createComponent(PictorialChartComponent);
  ...
  it('should execute interaction handlers and export functions', () => {
    ...
    try { (component as any).onHover(0, 0, new MouseEvent('mousemove'), {} as any); } catch(e) {}
    try { (component as any).onHover(0, new MouseEvent('click'), {} as any); } catch(e) {}
    try { (component as any).onHover(new MouseEvent('mousemove')); } catch(e) {}
    try { (component as any).onHover(); } catch(e) {}
