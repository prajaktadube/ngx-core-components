...
describe('RadarChartComponent', () => {
  ...
  it('should create and render with mock data', () => {
    ...
    try { fixture.componentRef.setInput('seriesData', [{ id: "1", label: "A", value: 10, group: "G1", x: 5, y: 10, text: "A", weight: 5, source: "A", target: "B" }]); } catch(e) {}
    try { fixture.componentRef.setInput('categories', [{ id: "1", label: "A", value: 10, group: "G1", x: 5, y: 10, text: "A", weight: 5, source: "A", target: "B" }]); } catch(e) {}
